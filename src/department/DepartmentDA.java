...
public class DepartmentDA {
    public DepartmentDA() throws FileNotFoundException {
        ...
        while(deptFile.hasNextLine()) {
            ...
            HashMap<String, Employee> deptEmpList = new HashMap<>();
            ...
            while(deptEmpFile.hasNextLine()) {
                ...
                deptEmpList.put(deptEmpDataArray[1].trim(), employee);
            ...
            for(HashMap.Entry<String, Employee> entry : deptEmpList.entrySet()) {
